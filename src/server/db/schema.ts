...
export const elearningCourses = sqliteTable(
  "elearning_courses",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
...
export const elearningSessions = sqliteTable(
  "elearning_sessions",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    courseId: integer("course_id")
      .notNull()
      .references(() => elearningCourses.id, { onDelete: "cascade" }),
    ...
    isEvaluation: integer("is_evaluation", { mode: "boolean" })
      .notNull()
      .default(false),
...
export const elearningMaterials = sqliteTable("elearning_materials", {
  ...
  sessionId: integer("session_id")
    .notNull()
    .references(() => elearningSessions.id, { onDelete: "cascade" }),
  title: text("title").notNull().default(""),
...
export const elearningAssignments = sqliteTable(
...
export const elearningQuizSubmissions = sqliteTable(
...
export const rombels = sqliteTable(
  "rombels",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
...
export const rombelStudents = sqliteTable(
  "rombel_students",
  {
    ...
    rombelId: integer("rombel_id")
      .notNull()
      .references(() => rombels.id, { onDelete: "cascade" }),
    studentId: integer("student_id")
      .notNull()
      .references(() => students.id, { onDelete: "cascade" }),
    createdAt: text("created_at").$defaultFn(() => new Date().toISOString()),
...
export const elearningSetups = sqliteTable("elearning_setups", {
  ...
  isAngketApproved: integer("is_angket_approved", { mode: "boolean" })
    .notNull()
    .default(false),
  createdAt: text("created_at").$defaultFn(() => new Date().toISOString()),
});
...
export const elearningForumPosts = sqliteTable("elearning_forum_posts", {
  ...
  parentId: integer("parent_id").references(
    (): AnySQLiteColumn => elearningForumPosts.id,
    { onDelete: "cascade" },
  ), // for replies
  createdAt: text("created_at").$defaultFn(() => new Date().toISOString()),
});

export const elearningAttendances = sqliteTable(
  "elearning_attendances",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    sessionId: integer("session_id")
      .notNull()
...
export const elearningSubmissions = sqliteTable(
  "elearning_submissions",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    assignmentId: integer("assignment_id")
      .notNull()
      .references(() => elearningAssignments.id, { onDelete: "cascade" }),
    studentId: integer("student_id")
      .notNull()
      .references(() => students.id, { onDelete: "cascade" }),
...
export const elearningEvaluationResponses = sqliteTable(
  "elearning_evaluation_responses",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    evaluationId: integer("evaluation_id")
      .notNull()
      .references(() => elearningEvaluations.id, { onDelete: "cascade" }),
    studentId: integer("student_id")
      .notNull()
      .references(() => students.id, { onDelete: "cascade" }),
    courseId: integer("course_id")
...
export const elearningSectionCompletions = sqliteTable(
  "elearning_section_completions",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    studentId: integer("student_id")
      .notNull()
    ...
    setupId: integer("setup_id")
      .notNull()
      .references(() => elearningSetups.id, { onDelete: "cascade" }),
    sectionKey: text("section_key").notNull(),
    completedAt: text("completed_at").$defaultFn(() =>
      new Date().toISOString(),
    ),
  },
  (t) => ({
...
export const tutorAttendances = sqliteTable(
  "tutor_attendances",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    tutorId: integer("tutor_id")
...
export const elearningSessionAngkets = sqliteTable(
  "elearning_session_angkets",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    sessionId: integer("session_id")
      .notNull()
    ...
    evaluationId: integer("evaluation_id")
      .notNull()
      .references(() => elearningEvaluations.id),
    score: integer("score").notNull(), // 1-5
    createdAt: text("created_at").$defaultFn(() => new Date().toISOString()),
  },
  (t) => ({
