      ...
      <div className="flex flex-wrap items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200/60 shadow-sm">
        <div>
          <h2 className="text-xl font-black text-cyan-900 tracking-tight flex items-center gap-2">
            <span>📅</span> KELOLA WEBSITE AGENDA
          </h2>
          <p className="text-xs text-slate-500 font-semibold mt-1">
            Atur agenda kegiatan, rapat, sosialisasi, dan pembelajaran yang diselenggarakan oleh PKBM Menuju Makmur.
          </p>
        </div>
      </div>
          ...
          <table className="w-full text-left text-sm border-collapse min-w-[1000px]">
            <thead>
              <tr className="bg-[#00badb] text-white font-black text-sm uppercase">
                ...
                <th className="py-4 px-6 border-r border-[#009cb9] w-48">NAMA AGENDA</th>
                <th className="py-4 px-6 border-r border-[#009cb9] w-36">PELAKSANAAN</th>
                <th className="py-4 px-6 border-r border-[#009cb9] w-36">WAKTU</th>
                <th className="py-4 px-6 border-r border-[#009cb9] w-32">PESERTA</th>
              ...
              {filteredAgendas.length === 0 ? (
                ...
                filteredAgendas.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6 border-r border-slate-100 text-slate-700 font-mono text-center">
                      {item.waktu}
                    </td>
