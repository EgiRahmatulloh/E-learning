            ...
            <div className="bg-white p-6 relative text-left">
              ...
              <div className="space-y-4 text-slate-800">
                <p className="text-xs font-semibold text-slate-500 leading-normal">
                  Upload data sarana dan fasilitas dari file Excel. Silakan download format terlebih dahulu.
                </p>

                <div className="space-y-3">
                  <a
                    href="/templates/format-upload-sarana.xlsx"
                    download
            ...
            <form className="flex-1 min-h-0 flex flex-col text-left" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="md:col-span-1 flex flex-col items-center justify-start pt-2">
                ...
                <div
                  ...
                  className="w-full aspect-square border-4 border-dashed border-cyan-300 hover:border-cyan-400 rounded-2xl flex flex-col items-center justify-center p-4 relative overflow-hidden transition-all text-center bg-cyan-50 hover:bg-cyan-100 cursor-pointer"
                >
                  <input
                ...
                <div className="w-full mt-4 flex flex-col gap-1 text-left">
                  <label className="text-[10px] font-black uppercase text-slate-500">URL Foto Sarana</label>
                  <input
                    type="text"
