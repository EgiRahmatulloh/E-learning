...
export default function KelolaElearning({ initialKelasId }: { initialKelasId?: string } = {}) {
  ...
  const selectedKelasId = initialKelasId || null;
  ...
  // Group rombels by kelas level — always show all 12 classes
      ...
      <div className="space-y-6">
          {selectedKelas ? (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-12 text-center">
              ...
              <h3 className="text-lg font-black text-slate-700">Kelas Tidak Ditemukan</h3>
              <p className="text-sm text-slate-500 mt-2">
                Silakan kembali dan pilih kelas yang valid.
              </p>
            </div>
          )}
        </div>
            ...
            <div className="flex items-center justify-between p-6 border-b border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 font-bold">{selectedKelas.nama} — Tahun Ajaran {getTahunAjaran()}</p>
                </div>
              </div>
              <button
